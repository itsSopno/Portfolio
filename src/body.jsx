...
useEffect(() => {
  ...
  return (
    <LenisScroll>
      {/* Hero Section */}
   <section className="section-one relative w-full min-h-screen flex flex-col justify-center items-center bg-black overflow-hidden rounded-3xl px-4 sm:px-6 lg:px-10">
